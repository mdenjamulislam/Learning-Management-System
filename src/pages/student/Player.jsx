    ...
    return (
        <>
            <div className="container">
                <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 py-10 md:py-16 lg:py-20">
                    {/* left */}
                        ...
                        {playerData ? (
                            <div>
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    <button className="">{false ? "Complete" : "Mask Complete"}</button>
                                </div>
                            </div>
                        ) : (
